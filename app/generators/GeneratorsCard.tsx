...
export default function GeneratorsCard({ product }: { product: Product }) {
  return (
    <Link
      ...
      className="group block rounded-2xl overflow-hidden border border-gray-300 transition-all duration-500 ease-in-out bg-white hover:shadow-xl p-4"
    >
      {/* Image */}
      ...
      {/* View Details (styled as button) */}
      <div className="w-full">
        <span className="block text-center w-full py-2 btn-primary shine-effect cursor-pointer">
          View Details
        </span>
      </div>
    </Link>
