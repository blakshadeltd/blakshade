...
interface HomeGeneratorsClientProps {
  searchParams: SearchParams;
}

const HomeGeneratorsClient: React.FC<HomeGeneratorsClientProps> = ({ searchParams }) => {
    ...
    <section>
      ...
      >
        <div className="container h-full flex items-end pb-4">
          <h1 className="text-[var(--background)] text-2xl md:text-4xl">Home Generators</h1>
        </div>
      </div>
...
export default HomeGeneratorsClient;