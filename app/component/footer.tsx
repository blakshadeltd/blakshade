    ...
    <footer className="relative spacer text-[var(--foreground,#2b2926)]">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          {/* Company Info - Slightly larger but balanced */}
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-4">BlakShade Ltd</h3>
              <p className="text-[var(--foreground,#2b2926)] mb-4 text-sm leading-relaxed">
                  ...
                  <ul className="space-y-1">
                    {items.slice(0, 3).map((item) => (
                      <li key={item.name}>
                        <Link
                          href={item.href}
                          className="text-[var(--foreground,#2b2926)] hover:text-[var(--hover)] text-sm block py-0.5"
                        >
                          {item.name}
                        </Link>
                      </li>
          ...
          {/* Information Links */}
          <div>
            <h4 className="text-lg mb-4 border-b border-gray-400 pb-2">Information</h4>
            <ul className="space-y-2">
              {infoMenuData.map((item) => (
                <li key={item.title}>
                  <Link
                    href={item.href}
                    className="text-[var(--foreground,#2b2926)] hover:text-[var(--hover)] transition-colors block py-1 text-sm"
                  >
                    {item.title}
                  </Link>
                </li>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg mb-4 border-b border-gray-400 pb-2">Quick Links</h4>
            <ul className="space-y-2">
              {[
                { name: 'Home', href: '/' },
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg mb-4 border-b border-gray-400 pb-2">Contact Us</h4>
            <address className="not-italic space-y-3 text-[var(--foreground,#2b2926)] mb-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">+44 7380 491992</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm">info@blakshade.com</span>
              </div>
            </address>
