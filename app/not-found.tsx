...
export default function Custom404() {
    return (
        <div className="rounded-[30px] mx-4 mb-4 flex items-center gap-6 justify-center h-[500px] bg-gray-300 text-[var(--foreground)] text-center overflow-hidden lg:h-screen">
